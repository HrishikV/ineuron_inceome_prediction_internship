...
print(df.info())
print(df.head())
df.replace(to_replace=df['maritial_status'].unique(),value=['single','married','single','single','single','married','single'], inplace=True)
...
df.replace(to_replace=['Femal','Male'],value=[0,1],inplace=True)
